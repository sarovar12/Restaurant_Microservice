    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public async Task<object> EmailCartRequest([FromBody] CartDTO cartDto)
        {
            try
            {
                ...
                await _messageBus.PublishMessage(cartDto, _configuration.GetValue<string>("TopicsAndQueues:EmailShoppingCartQueue"),_configuration.GetValue<string>("ConnectionStrings:MessagingBus"));
                _response.Result = true;
            }
            catch (Exception ex)
            {
